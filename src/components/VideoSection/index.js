...
const VideoSection = props => (
  <div className="container-fluid col-sm-12 blue-soft-bkg" id="video-container">
    <div>
      <Slider {...settings}>
        <div>
          <img className="js-item" src={bocconi} />
        </div>
        <div>
          <img className="js-item" src={cnr} />
        </div>
        <div>
          <img className="js-item" src={copernicani} />
        </div>
        <div>
          <img className="js-item" src={pi_campus} />
        </div>
        <div>
          <img className="js-item" src={sapienza} />
        </div>
        <div>
          <img className="js-item" src={translated} />
        </div>
        <div>
          <img className="js-item" src={ufsc} />
        </div>
        <div>
          <img className="js-item" src={be} />
        </div>
        <div>
          <img className="js-item" src={tesla} />
        </div>
      </Slider>
    </div>
        ...
        <div className="iframe-container">
          {props.intl.locale === "it" ? (
            <iframe
              width="640"
              height="375"
              src="https://www.youtube.com/embed/k2OcIFyb9GE"
              frameBorder="0"
            ...
            <iframe
              width="640"
              height="375"
              src="https://www.youtube.com/embed/l78iazHl_W8"
              frameBorder="0"
              allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture"
              allowFullScreen
            />
      ...
      <div className="col-4" style={{zIndex: 3, marginTop: '12px'}}>
        <div className="iframe-container">
          <iframe
            width="320"
            height="187"
            src="https://www.youtube.com/embed/kQJmwd2zS7g"
            frameborder="0"
        ...
        <div className="iframe-container">
          <iframe
            width="320"
            height="187"
            src="https://www.youtube.com/embed/KKhpp69jo6c"
            frameborder="0"
            allow="accelerometer; encrypted-media; gyroscope; picture-in-picture"
            allowfullscreen=""
          />
